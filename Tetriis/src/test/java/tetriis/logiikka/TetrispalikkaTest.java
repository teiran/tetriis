    ...
    public void testGetTetrispalikka() {
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            if (k[0][0] == 1 && k[0][1] == 1 && k[1][0] == 1 && k[1][1] == 1) { //nelö
                onko = true;
                random[0] ++;
            } else if (k[0][0] == 1 && k[0][1] == 2 && k[1][1] == 1 && k[1][2] == 1) {//salama oikealle
                onko = true;
                random[1] ++;
            } else if (k[0][0] == 1 && k[0][1] == 2 && k[0][2] == 1 && k[0][3] == 1) {//suora
                onko = true;
                random[2] ++;
            } else if (k[0][0] == 1 && k[0][1] == 2 && k[0][2] == 1 && k[1][2] == 1) { // l:llä oikealle
                onko = true;
                random[3] ++;
            } else if (k[0][0] == 1 && k[0][1] == 2 && k[0][2] == 1 && k[1][1] == 1) { // t
                onko = true;
                random[4] ++;
            } else if (k[1][0] == 1 && k[1][1] == 2 && k[1][2] == 1 && k[0][2] == 1) { // l:llä vasemmalle
                onko = true;
                random[5] ++;
            } else if (k[1][0] == 1 && k[1][1] == 2 && k[0][1] == 1 && k[0][2] == 1) { // salama vasemmalle
                onko = true;
                random[6] ++;
            }
